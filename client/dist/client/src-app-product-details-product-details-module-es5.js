(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["src-app-product-details-product-details-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProductDetailsComponentsProductDetailsProductDetailsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProductDetailsComponentsProductRelatedCardProductRelatedCardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProductDetailsComponentsProductRelatedProductRelatedComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProductDetailsComponentsProductDetailsProductDetailsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProductDetailsComponentsProductDetailsProductDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ProductDetailsComponent(activatedRoute, postService) {
        ...
        this.breadcrumbCategories = [{
          ...
          routerLink: '/danh-muc/san-pham-dat-nen'
        }, {
          title: 'Sản Phẩm Nhà Ở',
          routerLink: '/danh-muc/san-pham-nha-o'
        }, {
          title: 'Sản Phẩm Đã Bán',
          routerLink: '/danh-muc/san-pham-da-ban'
        }];
      ...
      _proto.ngOnInit = function ngOnInit() {
        ...
        this.subscriptions.add(this.activatedRoute.paramMap.subscribe(function (paramMap) {
          var postId = paramMap.get('postId');

          _this.getData(postId);
        }));
      };
      ...
      _proto.getData = function getData(postId) {
        var categoryId = postId.substring(0, postId.lastIndexOf('-'));
        this.post = this.postService.get(postId);
        this.listPostRelated = this.postService.getRelatedProducts(postId);
        this.breadcrumbItems[1] = this.breadcrumbCategories.find(function (md) {
          return md.routerLink.endsWith(categoryId);
        });
    ...
    ProductDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/product-details/components/product-details/product-details.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./product-details.component.scss */
      "./src/app/product-details/components/product-details/product-details.component.scss")).default]
  ...
  /***/
  function srcAppProductDetailsComponentsProductRelatedCardProductRelatedCardComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProductDetailsComponentsProductRelatedCardProductRelatedCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductRelatedCardComponent", function () {
      return ProductRelatedCardComponent;
    });
    /* harmony import */
    ...
    var ProductRelatedCardComponent =
    /*#__PURE__*/
    function () {
      function ProductRelatedCardComponent() {}

      var _proto2 = ProductRelatedCardComponent.prototype;
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ProductRelatedCardComponent.prototype, "post", void 0);
    ProductRelatedCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-product-related-card',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./product-related-card.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/product-details/components/product-related-card/product-related-card.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./product-related-card.component.scss */
      "./src/app/product-details/components/product-related-card/product-related-card.component.scss")).default]
  ...
  /***/
  function srcAppProductDetailsComponentsProductRelatedProductRelatedComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProductDetailsComponentsProductRelatedProductRelatedComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      var _proto3 = ProductRelatedComponent.prototype;
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ProductRelatedComponent.prototype, "listPost", void 0);
    ProductRelatedComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-product-related',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./product-related.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/product-details/components/product-related/product-related.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./product-related.component.scss */
      "./src/app/product-details/components/product-related/product-related.component.scss")).default]
  ...
  function srcAppProductDetailsProductDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_product_details_product_details_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
  ...
  function srcAppProductDetailsProductDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_product_related_product_related_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/product-related/product-related.component */
    "./src/app/product-details/components/product-related/product-related.component.ts");
    /* harmony import */
    ...
    var _components_product_related_card_product_related_card_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/product-related-card/product-related-card.component */
    "./src/app/product-details/components/product-related-card/product-related-card.component.ts");
    ...
    ProductDetailsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], _product_details_routing_module__WEBPACK_IMPORTED_MODULE_3__["ProductDetailsRoutingModule"]]
    })], ProductDetailsModule);
    /***/
  }
}]); //# sourceMappingURL=src-app-product-details-product-details-module-es2015.js.map
//# sourceMappingURL=src-app-product-details-product-details-module-es5.js.map